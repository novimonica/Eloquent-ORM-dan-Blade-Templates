    ...
    <div class="container mt-4">
        ...
        <div class="table-responsive border p-3 rounded-3">
            <table class="table table-bordered table-hover table-striped mb-0 bg-white">
                ...
                <tbody>
                     <?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <!--digunakan untuk perulangan pada variable '$employee' -->
                        <tr>
                            ...
                            <td>
                                <div class="d-flex">
                                    <!-- menampilakn tombol dengan ikon yang menampilkan rincian karyawan. tombol ini mengarah ke route 'employee.show' dengan parameter 'employee_id' -->
                                    ...
                                    <!-- menampilakn tombol dengan ikon edit karyawan. tombol ini mengarah ke route 'employee.edit' dengan parameter 'employee_id' -->
                                    ...
                                    <div>
                                        <!-- form ini dibuat untuk menghapus data karyawan yang mengarah ke routr 'employees.destroy' -->
...
<?php /**PATH /Users/novimonica/Documents/SEMESTER 4/Pemrograman Framework/Praktikum/MODUL_4/ControllerView/resources/views/employee/actions.blade.php ENDPATH**/ ?>
                ...
                <div class="p-5 bg-light rounded-3 col-xl-4 border">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <input class="form-control @error('age') is-invalid @enderror " type="number" name="age" id="age" value="{{ $employee->age }}" placeholder="Enter Age">
                        </div>
                        <div class="col-md-12 mb-3">
                            <label for="age" class="form-label">Position</label>
                            <select name="position" id="position" class="form-select">
                                    <option value="{{ $employee->position_id }}">{{$employee->code.' - '.$employee->position_name}}</option>
                                    @foreach ($positions as $position)
                                    @if ($position->name !== $employee->position_name)
